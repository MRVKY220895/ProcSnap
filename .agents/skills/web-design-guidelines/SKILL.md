...
2. Check against all rules in the guidelines below (or fetch fresh rules from `https://raw.githubusercontent.com/vercel-labs/web-interface-guidelines/main/command.md`)
